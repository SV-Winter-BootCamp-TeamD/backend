...
from .views import CanvasCreateView, CanvasUpdateDeleteView, MemberInvite, CanvasSaveView
...
urlpatterns = [
    ...
    path('<int:canvas_id>/', CanvasUpdateDeleteView, name='update/delete-canvas'),
